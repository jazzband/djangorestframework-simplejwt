...
- Fixed OpenAPI schema generation for token obtain endpoints by explicitly declaring dynamically returned fields (`access`, `refresh`) as read-only serializer fields.
