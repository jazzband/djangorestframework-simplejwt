...
export async function defineConfig(env) {
  ...
  const pluginConfig = {
    pathPattern: "./rest_framework_simplejwt/locale/{language}/LC_MESSAGES/django.po",
  };

  return {
    referenceLanguage: "en",
    languages: ["cs","de","es","es_AR","es_CL","fa_IR","fr","id_ID","it_IT","ko_KR","nl_NL","pl_PL","pt_BR","ro","ru_RU","sl","sv","tr","uk_UA","zh_Hans"],
    readResources: (args) =>
